namespace AtomicTorch.CBND.CoreMod.Systems.Droplists
{
    ...
    public class DropItemsList : IReadOnlyDropItemsList
    {
        ...
        public static readonly double DropListItemsCountMultiplierPvE;
        ...
        static DropItemsList()
        {
            ...
            DropListItemsCountMultiplierPvE = ServerRates.Get(
                "DropListItemsCountMultiplierPvE",
                defaultValue: Api.IsServer && SharedLocalServerHelper.IsLocalServer
                                  ? 1.5
                                  : 1.0,
                @"This rate determines the item droplist multiplier.                
            ...
            double probabilityMultiplier)
        {
            ...
            if(dropItemContext.HasCharacter)
            {
                probabilityMultiplier *= PvEZoneMultiplier.getDropListItemCountMultiplier(dropItemContext.Character);
            }
            else if(dropItemContext.HasStaticWorldObject)
            {
                probabilityMultiplier *= PvEZoneMultiplier.getDropListItemCountMultiplier(dropItemContext.StaticWorldObject);
            }
            else
            {
