namespace AtomicTorch.CBND.CoreMod.CraftRecipes
{
    ...
    public class RecipeRepairPowerBankStandard : Recipe.RecipeForStationCrafting
    {
            ...
            OutputItems outputItems)
        {
            ...
            inputItems.Add<ItemComponentsElectronic>(count: 2);
			inputItems.Add<ItemGlue>(count: 1);
			inputItems.Add<ItemPowerBankStandard>(count: 1);
