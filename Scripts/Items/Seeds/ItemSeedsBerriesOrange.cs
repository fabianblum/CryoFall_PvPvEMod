namespace AtomicTorch.CBND.CoreMod.Items.Seeds
{
    ...
    public class ItemSeedsBerriesOrange : ProtoItemSeed
    {
        public override string Description => "Orange berry seeds prepared for planting.";

        public override string Name => "Orange berry seeds";
        ...
        {
            objectPlantProto = GetPlant<ObjectPlantYellow>();
