namespace AtomicTorch.CBND.CoreMod.Items.Seeds
{
    ...
    public class ItemSeedsYucca : ProtoItemSeed
    {
        public override string Description => "Yucca seeds prepared for planting.";

        public override string Name => "Yucca seeds.";
        ...
        {
            objectPlantProto = GetPlant<ObjectPlantYucca>();
