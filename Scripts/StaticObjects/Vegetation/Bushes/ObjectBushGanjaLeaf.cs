namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Bushes
{
    ...
    public class ObjectBushGanjaLeaf : ProtoObjectBush
    {
        public override string Name => "Ganja Leaf";
        ...
        {
            droplist
                .Add<ItemGanjaLeaf>(count: 3)
                .Add<ItemGanjaLeaf>(count: 2,
                                        probability: 1 / 5.0,
                                        condition: SkillForaging.ConditionAdditionalYield);

            // saplings drop (requires skill)
            droplist
                .Add<ItemSeedsGanja>(condition: SkillLumbering.ConditionGetSapplings,
                                            count: 1,
                                            probability: 0.15)
                .Add<ItemSeedsGanja>(condition: SkillLumbering.ConditionGetExtraSapplings,
                                            count: 1,
                                            probability: 0.15);
        }
