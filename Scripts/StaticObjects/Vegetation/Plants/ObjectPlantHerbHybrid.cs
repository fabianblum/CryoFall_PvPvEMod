namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantHerbHybrid : ProtoObjectPlant
    {
        public override string Name => "Hybrid herb";
        ...
        {
            droplist.Add<ItemHerbGreen>(count: 2, countRandom: 2);
            droplist.Add<ItemHerbRed>(count: 2, countRandom: 2);
            droplist.Add<ItemHerbPurple>(count: 2, countRandom: 2);
            // additional yield
            droplist.Add<ItemHerbGreen>(count: 2, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemHerbGreen>(count: 1, condition: SkillFarming.ConditionExtraYield, probability: 0.05f);
            droplist.Add<ItemHerbRed>(count: 2, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemHerbRed>(count: 1, condition: SkillFarming.ConditionExtraYield, probability: 0.05f);
            droplist.Add<ItemHerbPurple>(count: 2, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemHerbPurple>(count: 1, condition: SkillFarming.ConditionExtraYield, probability: 0.05f);
        }
