namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantMushroomPennyBun : ProtoObjectPlant
    {
        ...
        {
            droplist.Add<ItemMushroomPennyBun>(count: 2, countRandom: 2);

            // additional yield
            droplist.Add<ItemMushroomPennyBun>(count: 2, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemMushroomPennyBun>(count: 1, condition: SkillFarming.ConditionExtraYield, probability: 0.05f);
        }
