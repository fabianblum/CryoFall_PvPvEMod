namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantPurple : ProtoObjectPlant
    {
        public override string Name => "Purple berry bush";
        ...
        {
            droplist.Add<ItemBerriesViolet>(count: 2, countRandom: 2);

            // additional yield
            droplist.Add<ItemBerriesViolet>(count: 1, countRandom: 1, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemBerriesViolet>(count: 1,
                                          countRandom: 1,
