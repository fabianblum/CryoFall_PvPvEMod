namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantPineapple : ProtoObjectPlant
    {
        ...
        {
            droplist.Add<ItemPineapple>(count: 3, countRandom: 2);

            // additional yield
            droplist.Add<ItemPineapple>(count: 2, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemPineapple>(count: 1, condition: SkillFarming.ConditionExtraYield, probability: 0.05f);
        }
