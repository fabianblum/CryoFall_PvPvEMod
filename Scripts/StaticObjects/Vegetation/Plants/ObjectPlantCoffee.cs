namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantCoffee : ProtoObjectPlant
    {
        public override string Name => "Coffee Plant";
        ...
        {
            droplist.Add<ItemCoffeeBerries>(count: 3, countRandom: 2);

            // additional yield
            droplist.Add<ItemCoffeeBerries>(count: 1, countRandom: 1, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemCoffeeBerries>(count: 1,
                                          countRandom: 1,
