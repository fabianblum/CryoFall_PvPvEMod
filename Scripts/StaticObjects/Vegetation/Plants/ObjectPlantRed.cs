namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantRed : ProtoObjectPlant
    {
        public override string Name => "Red berry bush";
        ...
        {
            droplist.Add<ItemBerriesRed>(count: 2, countRandom: 2);

            // additional yield
            droplist.Add<ItemBerriesRed>(count: 1, countRandom: 1, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemBerriesRed>(count: 1,
                                          countRandom: 1,
