namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantYucca : ProtoObjectPlant
    {
        public override string Name => "Yucca plant";
        ...
        {
            droplist.Add<ItemYucca>(count: 3, countRandom: 3);

            // additional yield
            droplist.Add<ItemYucca>(count: 1, countRandom: 1, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemYucca>(count: 1,
                                          countRandom: 1,
