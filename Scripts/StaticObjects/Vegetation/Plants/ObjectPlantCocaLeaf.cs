namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantCocaLeaf : ProtoObjectPlant
    {
        public override string Name => "Coca Leaf Plant";
        ...
        {
            droplist.Add<ItemCocaLeaf>(count: 3, countRandom: 2);

            // additional yield
            droplist.Add<ItemCocaLeaf>(count: 1, countRandom: 1, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemCocaLeaf>(count: 1,
                                          countRandom: 1,
