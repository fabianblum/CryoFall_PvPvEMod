namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantOilpod : ProtoObjectPlant
    {
        public override string Name => "Oilpod bush";
        ...
        {
            droplist.Add<ItemOilpod>(count: 3, countRandom: 3);

            // additional yield
            droplist.Add<ItemOilpod>(count: 1, countRandom: 1, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemOilpod>(count: 1,
                                          countRandom: 1,
