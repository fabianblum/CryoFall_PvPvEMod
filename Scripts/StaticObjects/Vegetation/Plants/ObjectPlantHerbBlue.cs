namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantHerbBlue : ProtoObjectPlant
    {
        ...
        {
            droplist.Add<ItemHerbBlue>(count: 3, countRandom: 2);

            // additional yield
            droplist.Add<ItemHerbBlue>(count: 2, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemHerbBlue>(count: 1, condition: SkillFarming.ConditionExtraYield, probability: 0.05f);
        }
