namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantMushroomPink : ProtoObjectPlant
    {
        ...
        {
            droplist.Add<ItemMushroomPink>(count: 3, countRandom: 3);

            // additional yield
            droplist.Add<ItemMushroomPink>(count: 2, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemMushroomPink>(count: 1, condition: SkillFarming.ConditionExtraYield, probability: 0.05f);
        }
