namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantWaterbulb : ProtoObjectPlant
    {
        public override string Name => "Waterbulb bush";
        ...
        {
            droplist.Add<ItemWaterbulb>(count: 3, countRandom: 2);

            // additional yield
            droplist.Add<ItemWaterbulb>(count: 1, countRandom: 1, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemWaterbulb>(count: 1,
                                          countRandom: 1,
