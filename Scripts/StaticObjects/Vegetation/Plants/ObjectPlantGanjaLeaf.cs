namespace AtomicTorch.CBND.CoreMod.StaticObjects.Vegetation.Plants
{
    ...
    public class ObjectPlantGanjaLeaf : ProtoObjectPlant
    {
        public override string Name => "Ganja Leaf Plant";

        public override byte NumberOfHarvests => 5;
        ...
        {
            droplist.Add<ItemGanjaLeaf>(count: 5, countRandom: 2);

            // additional yield
            droplist.Add<ItemGanjaLeaf>(count: 1, countRandom: 1, condition: ItemFertilizer.ConditionExtraYield);
            droplist.Add<ItemGanjaLeaf>(count: 1,
                                          countRandom: 1,
