namespace AtomicTorch.CBND.CoreMod.StaticObjects.Misc.Events
{
          ...
          IProtoObjectHackableContainer
    {
        ...
        public readonly double serverRateLootCountMultiplier;

        public readonly double serverRateLootCountMultiplierPvE;
        ...
        protected virtual double ServerGetDropListProbabilityMultiplier(IStaticWorldObject worldObject)
        {
            ...
            return this.serverRateLootCountMultiplier
                   / PvEZoneMultiplier.getLootCountMultiplier(worldObject, this.serverRateLootCountMultiplier, this.serverRateLootCountMultiplierPvE);
        }
    }
}