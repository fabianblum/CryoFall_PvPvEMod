namespace AtomicTorch.CBND.CoreMod.StaticObjects.Structures.CraftingStations
{
    ...
    public class ObjectRepairWorkbench : ProtoObjectCraftStation
    {
        public override string Description =>
            "A workbench outfitted to repair armor and weapons.";

        public override string Name => "Repair Workbench";
