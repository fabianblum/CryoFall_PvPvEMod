namespace AtomicTorch.CBND.CoreMod.Rates
{
  ...
  public class RateMigrationMutantMobCountPvE
      : BaseRate<RateMigrationMutantMobCountPvE, string>
  {
    public static ushort[] SharedValues { get; private set; }

    public override string Description => @"Number of mobs for each claims (T1 to T5) (PvE).";

    public override string Id => "MigrationMutant.MobCountsPvE";

    public override string Name => "Mutant migration mob counts PvE";
