    ...
    public class ZoneBorealForest : ProtoZoneDefault
    {
        ...
        protected override void PrepareZone(ZoneScripts scripts)
        {
            ...
            scripts
                ...
                .Add(GetScript<SpawnResourceHerbs>().Configure(densityMultiplier: 0.40))
                .Add(GetScript<SpawnResourceHerbBlue>().Configure(densityMultiplier: 0.30));

            // loot
            scripts
                .Add(GetScript<SpawnLootBoreal>().Configure(densityMultiplier: 2.0)) // loot (stone, grass, twigs)
                .Add(GetScript<SpawnLootPileWood>().Configure(densityMultiplier: 2.5))
                .Add(GetScript<SpawnLootPileStone>().Configure(densityMultiplier: 0.4));
